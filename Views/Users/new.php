...
<form action="/users" method="post" enctype="multipart/form-data">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="username" id="username" class="form-control" value="<?= set_value('email') ?>">
    <?php if (isset($errors) and $errors->getError('username')) { ?>
      <div class='text-danger mt-2'>
        <?= $error = $errors->getError('username'); ?>
      </div>
    <?php } ?>
  </div>
  <div class="mb-3">
